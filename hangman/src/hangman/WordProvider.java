...
public class WordProvider {
    ...
    private void CategoryWords() {
    	...
    	wordsByCategory.put(2, Arrays.asList(
    		    ...
    		    "PANDA", "FROG", "WHALE", "EAGLE", "SHEEP"
    		));
    	wordsByCategory.put(3, Arrays.asList(
    		    "TABLE", "CHAIR", "CLOCK", "BOOK", "PEN",
    		    "LAMP", "BAG", "DOOR", "KEY", "CUP"
    		));
    	wordsByCategory.put(4, Arrays.asList(
    		    "RUN", "EAT", "JUMP", "PLAY", "READ",
    		    "SING", "SWIM", "DRIVE", "COOK", "DRAW"
    		));
    }
    
    public String getRandomWord(int categoryKey) {
        List<String> words = wordsByCategory.get(categoryKey);
        
        if (words == null || words.isEmpty()) {
            throw new IllegalArgumentException("해당 카테고리에 단어가 없습니다.");
        }
